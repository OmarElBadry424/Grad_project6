...
class _MyHomePageeState extends State<MyHomePagee> {
  void response(query) async {
    AuthGoogle authGoogle = await AuthGoogle(
        fileJson: "assets/json/social.json")
        .build();
      ...
      child: Row(
        ...
        children: [
          ...
          data == 1? Container(
            ...
            width: 60,
            child: CircleAvatar(
              backgroundImage: AssetImage("lib/assets/images/default.jpg"),
            ),
          ) : Container(),
  ...
  Dialogflow({required AuthGoogle authGoogle, required String language}) {}
}