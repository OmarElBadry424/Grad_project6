  ...
  Widget build(BuildContext context) {
    return  Scaffold( appBar: AppBar(
      ...
      leading: IconButton(
          ...
          onPressed: () =>   Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) =>LoginPage(onTap: onTap),
          )
          )
      ),
    ),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Let\'s create an account fr you!',
                  style: TextStyle(
...
//email textfield
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap:() {
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) =>LoginPage(onTap: onTap),
                        )
                        );
                      },
